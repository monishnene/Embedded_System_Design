M:i2c
F:G$i2c_clock_tick$0$0({2}DF,SV:S),C,0,0,0,0,0
F:G$sda$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$scl$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$acknowledge_check$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$no_acknowledge$0$0({2}DF,SV:S),C,0,0,0,0,0
F:G$start_i2c$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$stop_i2c$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$write_byte$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$read_byte$0$0({2}DF,SC:U),Z,0,0,0,0,0
F:G$eeprom_write$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$eeprom_read$0$0({2}DF,SC:U),Z,0,0,0,0,0
F:G$i2c_eeprom_flush$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$eeprom_reset$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Li2c_eeprom_flush$sloc0$1$0({2}SI:U),E,0,0
S:G$loop$0$0({1}SC:U),F,0,0
S:G$lcd_current_column$0$0({1}SC:U),F,0,0
S:G$lcd_current_row$0$0({1}SC:U),F,0,0
S:Lsda$value$1$1({1}SC:U),F,0,0
S:Lscl$value$1$1({1}SC:U),F,0,0
S:Lwrite_byte$data_byte$1$1({1}SC:U),F,0,0
S:Lwrite_byte$i$1$1({1}SC:U),F,0,0
S:Lread_byte$i$1$1({1}SC:U),F,0,0
S:Lread_byte$value$1$1({1}SC:U),F,0,0
S:Leeprom_write$data_byte$1$1({1}SC:U),F,0,0
S:Leeprom_write$address$1$1({2}SI:U),F,0,0
S:Leeprom_write$address_LSB$1$1({1}SC:U),F,0,0
S:Leeprom_write$address_MSB$1$1({1}SC:U),F,0,0
S:Leeprom_read$address$1$1({2}SI:U),F,0,0
S:Leeprom_read$address_LSB$1$1({1}SC:U),F,0,0
S:Leeprom_read$address_MSB$1$1({1}SC:U),F,0,0
S:Leeprom_read$data_value$1$1({1}SC:U),F,0,0
S:Li2c_eeprom_flush$i2c_eeprom_flush_txt$1$1({21}DA21,SC:U),F,0,0
S:Li2c_eeprom_flush$count$1$1({1}SC:U),F,0,0
S:Li2c_eeprom_flush$i$1$1({1}SC:U),F,0,0
S:Li2c_eeprom_flush$temp_storage$1$1({1}SC:U),F,0,0
S:Li2c_eeprom_flush$data_byte$1$1({1}SC:U),F,0,0
S:Li2c_eeprom_flush$address$1$1({2}SI:U),F,0,0
S:Leeprom_reset$i$1$1({1}SC:U),F,0,0
...
S:G$i2c_clock_tick$0$0({2}DF,SV:S),C,0,0
S:G$no_acknowledge$0$0({2}DF,SV:S),C,0,0
