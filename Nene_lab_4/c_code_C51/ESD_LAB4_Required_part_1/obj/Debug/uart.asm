...
;------------------------------------------------------------
	G$int_to_char$0$0 ==.
	C$uart.c$17$0$0 ==.
;	uart.c:17: int8_t int_to_char(int temp)           /*Function that includes switch statement for hex definition*/
;	-----------------------------------------
...
;	genReceive
	...
	movx	@dptr,a
	C$uart.c$19$1$1 ==.
;	uart.c:19: switch(temp)            /*switch case for defining hex characters above 9 i.e. 'A' to 'F'*/
;	genAssign
	mov	dptr,#_int_to_char_temp_1_1
	movx	a,@dptr
	mov	r2,a
...
;------------------------------------------------------------
	G$char_to_int$0$0 ==.
	C$uart.c$79$1$1 ==.
;	uart.c:79: uint8_t char_to_int(uint8_t temp)
;	-----------------------------------------
...
00109$:
	C$uart.c$85$1$1 ==.
;	uart.c:85: else if((temp>='a')&&(temp<='f'))
;	genAssign
	mov	dptr,#_char_to_int_temp_1_1
	movx	a,@dptr
	mov	r2,a
...
00105$:
	C$uart.c$90$1$1 ==.
;	uart.c:90: else if((temp>='A')&&(temp<='f'))
;	genAssign
	mov	dptr,#_char_to_int_temp_1_1
	movx	a,@dptr
	mov	r2,a
...
;------------------------------------------------------------
	...
	C$uart.c$104$1$1 ==.
;	uart.c:104: void print_number_hex(__xdata uint32_t number,__xdata uint8_t display_width)
;	-----------------------------------------
...
;	genReceive
	...
	movx	@dptr,a
	C$uart.c$109$1$1 ==.
;	uart.c:109: for(counter=display_width;counter>1;counter--)
;	genAssign
...
;	Peephole 300	removed redundant label 00143$
	C$uart.c$116$4$4 ==.
;	uart.c:116: if(number<=value_check)
;	genIfx
	mov	a,r3
;	genIfxJump
...
00104$:
	C$uart.c$126$4$6 ==.
;	uart.c:126: if(number<=value_check)
;	genIfx
	mov	a,r0
;	genIfxJump
;	Peephole 108.b	removed ljmp by inverse jump logic
...
00107$:
	C$uart.c$136$4$8 ==.
;	uart.c:136: if(number<=value_check)
;	genIfx
	mov	a,r7
;	genIfxJump
;	Peephole 108.b	removed ljmp by inverse jump logic
...
00111$:
	C$uart.c$146$2$10 ==.
;	uart.c:146: temp_ascii_store[counter]=int_to_char(number%16);
;	genPlus
...
00147$:
	C$uart.c$150$1$1 ==.
;	uart.c:150: for(counter-=1;counter>=0;counter--)
;	genMinus
;	genMinusDec
	mov	a,r2
	dec	a
...
;	Peephole 300	removed redundant label 00148$
	C$uart.c$152$2$11 ==.
;	uart.c:152: putchar(temp_ascii_store[counter]);
;	genPlus
;	Peephole 236.g	used r2 instead of ar2
	mov	a,r2
	add	a,#_print_number_hex_temp_ascii_store_1_1
...
;------------------------------------------------------------
	G$getchar$0$0 ==.
	C$uart.c$162$1$1 ==.
;	uart.c:162: uint8_t getchar (void)
;	-----------------------------------------
;	 function getchar
;	-----------------------------------------
_getchar:
	C$uart.c$165$1$1 ==.
;	uart.c:165: while (!RI);                // compare asm code generated for these three lines
00101$:
;	genIfx
;	genIfxJump
;	Peephole 108.d	removed ljmp by inverse jump logic
	C$uart.c$168$1$1 ==.
;	uart.c:168: RI = 0;			// clear RI flag
;	genAssign
...
00108$:
	C$uart.c$169$1$1 ==.
;	uart.c:169: return SBUF;  	// return character from SBUF
;	genRet
	mov	dpl,_SBUF
...
;------------------------------------------------------------
	G$putchar$0$0 ==.
	C$uart.c$178$1$1 ==.
;	uart.c:178: void putchar (__xdata uint8_t c)
;	-----------------------------------------
;	 function putchar
;	-----------------------------------------
_putchar:
;	genReceive
	...
	movx	@dptr,a
	C$uart.c$180$1$1 ==.
;	uart.c:180: while(!TI); //wait for transmitter to be ready
00101$:
;	genIfx
;	genIfxJump
;	Peephole 108.d	removed ljmp by inverse jump logic
...
;	Peephole 300	removed redundant label 00108$
	C$uart.c$181$1$1 ==.
;	uart.c:181: SBUF = c; //write character to transmit buffer
;	genAssign
	mov	dptr,#_putchar_c_1_1
	movx	a,@dptr
	mov	_SBUF,a
	C$uart.c$182$1$1 ==.
;	uart.c:182: TI = 0; //clear the TI flag
;	genAssign
	clr	_TI
;	Peephole 300	removed redundant label 00104$
	C$uart.c$183$1$1 ==.
...
;------------------------------------------------------------
	G$init_hardware$0$0 ==.
	C$uart.c$189$1$1 ==.
;	uart.c:189: void init_hardware(void)
;	-----------------------------------------
;	 function init_hardware
;	-----------------------------------------
_init_hardware:
	C$uart.c$192$1$1 ==.
;	uart.c:192: IEN0|=0x80;
;	genOr
	orl	_IEN0,#0x80
	C$uart.c$193$1$1 ==.
;	uart.c:193: IPL0 |= 0x10;
;	genOr
	orl	_IPL0,#0x10
	C$uart.c$194$1$1 ==.
;	uart.c:194: TMOD |= 0x20; //TIMER 1, MODE 2
;	genOr
	orl	_TMOD,#0x20
	C$uart.c$195$1$1 ==.
;	uart.c:195: SCON |= 0x50; //8 BIT, 1 STOP , REN ENABLED
;	genOr
	orl	_SCON,#0x50
	C$uart.c$196$1$1 ==.
;	uart.c:196: TCON |= 0x40; 	//START TIMER1
;	genOr
	orl	_TCON,#0x40
	C$uart.c$197$1$1 ==.
;	uart.c:197: TH1 = 0xFD;
...
;------------------------------------------------------------
	G$my_printf$0$0 ==.
	C$uart.c$206$1$1 ==.
;	uart.c:206: void my_printf(__xdata uint8_t* text_ptr)
;	-----------------------------------------
;	 function my_printf
;	-----------------------------------------
_my_printf:
...
;------------------------------------------------------------
	G$print_number$0$0 ==.
	C$uart.c$221$1$1 ==.
;	uart.c:221: void print_number(__xdata uint32_t number)
;	-----------------------------------------
...
00101$:
	C$uart.c$227$2$2 ==.
;	uart.c:227: temp_ascii_store[counter]='0'+number%10;
;	genPlus
;	Peephole 236.g	used r2 instead of ar2
	mov	a,r2
...
00116$:
	C$uart.c$231$1$1 ==.
;	uart.c:231: for(counter-=1;counter>=0;counter--)
;	genMinus
;	genMinusDec
	mov	a,r2
	dec	a
...
;	Peephole 300	removed redundant label 00117$
	C$uart.c$233$2$3 ==.
;	uart.c:233: putchar(temp_ascii_store[counter]);
;	genPlus
;	Peephole 236.g	used r2 instead of ar2
	mov	a,r2
	add	a,#_print_number_temp_ascii_store_1_1
...
;------------------------------------------------------------
	G$fetch_number$0$0 ==.
	C$uart.c$244$1$1 ==.
;	uart.c:244: uint16_t fetch_number(uint8_t base)
;	-----------------------------------------
...
;	genReceive
	...
	movx	@dptr,a
	C$uart.c$246$1$1 ==.
;	uart.c:246: __xdata uint8_t scanned_digit=0,digit_array[20],digit_counter=0,i=0;
;	genAssign
...
;	Peephole 219.a	removed redundant clear
	C$uart.c$247$1$1 ==.
;	uart.c:247: __xdata uint16_t number=0;
;	genAssign
	clr	a
	movx	@dptr,a
...
;	Peephole 219.b	removed redundant clear
	...
	movx	@dptr,a
	C$uart.c$248$3$3 ==.
;	uart.c:248: while(scanned_digit!=13)
00111$:
;	genAssign
	mov	dptr,#_fetch_number_scanned_digit_1_1
	movx	a,@dptr
...
00129$:
	C$uart.c$250$2$2 ==.
;	uart.c:250: scanned_digit=getchar();
;	genCall
	lcall	_getchar
	mov	r2,dpl
;	genAssign
	...
	movx	@dptr,a
	C$uart.c$251$2$2 ==.
;	uart.c:251: if(((scanned_digit >= '0') && (scanned_digit <= '9'))||
;	genCmpLt
;	genCmp
	cjne	r2,#0x30,00130$
00130$:
...
00108$:
	C$uart.c$252$2$2 ==.
;	uart.c:252: ((scanned_digit >= 'a') && (scanned_digit <= 'f'))||
;	genCmpLt
;	genCmp
	cjne	r2,#0x61,00133$
00133$:
...
00110$:
	C$uart.c$253$2$2 ==.
;	uart.c:253: ((scanned_digit >= 'A') && (scanned_digit <= 'F')))
;	genCmpLt
;	genCmp
	cjne	r2,#0x41,00136$
00136$:
...
00103$:
	C$uart.c$255$3$3 ==.
;	uart.c:255: putchar(scanned_digit);
;	genCall
	mov	dpl,r2
	push	ar2
	lcall	_putchar
	pop	ar2
	C$uart.c$256$3$3 ==.
;	uart.c:256: digit_array[digit_counter]=char_to_int(scanned_digit);
;	genAssign
	mov	dptr,#_fetch_number_digit_counter_1_1
	movx	a,@dptr
;	genPlus
...
00104$:
	C$uart.c$259$2$2 ==.
;	uart.c:259: else if(scanned_digit==8) //check for backspace
;	genCmpEq
;	gencjneshort
	cjne	r2,#0x08,00139$
	sjmp	00140$
...
00140$:
	C$uart.c$261$3$4 ==.
;	uart.c:261: putchar(8); //print backspace
;	genCall
	mov	dpl,#0x08
	lcall	_putchar
	C$uart.c$262$3$4 ==.
;	uart.c:262: putchar(32); //print space
;	genCall
	mov	dpl,#0x20
	lcall	_putchar
	C$uart.c$263$3$4 ==.
;	uart.c:263: putchar(8); //print backspace
;	genCall
	mov	dpl,#0x08
	lcall	_putchar
	C$uart.c$264$3$4 ==.
;	uart.c:264: digit_counter--;
;	genAssign
	mov	dptr,#_fetch_number_digit_counter_1_1
	movx	a,@dptr
;	genMinus
...
;	genAssign
	...
	ljmp	00111$
	C$uart.c$267$1$1 ==.
;	uart.c:267: for(i=0;i<digit_counter;i++)
00127$:
;	genAssign
	mov	dptr,#_fetch_number_base_1_1
	movx	a,@dptr
...
;	genAssign
	...
	movx	@dptr,a
	C$uart.c$270$2$5 ==.
;	uart.c:270: number+= digit_array[i];
;	genPlus
...
;------------------------------------------------------------
	G$ms_delay$0$0 ==.
	C$uart.c$280$1$1 ==.
;	uart.c:280: void ms_delay(uint32_t time)
;	-----------------------------------------
;	 function ms_delay
;	-----------------------------------------
_ms_delay:
...
;	Peephole 300	removed redundant label 00116$
	C$uart.c$285$1$1 ==.
;	uart.c:285: for(i=0;i<1120;i++); //1 ms
;	genAssign
...
;------------------------------------------------------------
	G$us_delay$0$0 ==.
	C$uart.c$296$1$1 ==.
;	uart.c:296: void us_delay(uint32_t time)
;	-----------------------------------------
;	 function us_delay
;	-----------------------------------------
_us_delay:
;	genReceive
	...
	movx	@dptr,a
	C$uart.c$299$1$1 ==.
;	uart.c:299: for(i=0;i<(1.12*time);i++); //1 tick 1 us
;	genAssign
	mov	dptr,#_us_delay_time_1_1
	movx	a,@dptr
...
;------------------------------------------------------------
	G$wake_up$0$0 ==.
	C$uart.c$307$1$1 ==.
;	uart.c:307: void wake_up(void)  interrupt 4
;	-----------------------------------------
;	 function wake_up
;	-----------------------------------------
_wake_up:
