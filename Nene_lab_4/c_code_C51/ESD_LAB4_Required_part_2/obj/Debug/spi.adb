...
F:G$dac_next_value$0$0({2}DF,SI:U),Z,0,0,0,0,0
F:G$dac_next_value$0$0({2}DF,SI:U),Z,0,0,0,0,0
...
F:G$dac_output_control_change$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$dac_next_wave$0$0({2}DF,SC:U),Z,0,0,0,0,0
F:G$dac_increase_voltage$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$dac_decrease_voltage$0$0({2}DF,SV:S),Z,0,0,0,0,0
T:Fspi$__00010000[({0}S:S$id$0$0({1}SC:U),Z,0,0)({1}S:S$on_off$0$0({1}SC:U),Z,0,0)({2}S:S$gain$0$0({1}SC:U),Z,0,0)({3}S:S$value$0$0({2}SI:U),Z,0,0)({5}S:S$wave$0$0({1}SC:U),Z,0,0)]
S:G$loop$0$0({1}SC:U),F,0,0
S:Fspi$a$0$0({6}ST__00010000:S),F,0,0
S:Fspi$b$0$0({6}ST__00010000:S),F,0,0
S:G$output_channel_ptr$0$0({2}DX,ST__00010000:S),F,0,0
S:Lspi_write_word$data_word$1$1({2}SI:U),F,0,0
S:Lspi_write_word$i$1$1({1}SC:U),F,0,0
S:Ldac_update_output$output_channel_local_ptr$1$1({2}DX,ST__00010000:S),F,0,0
S:Ldac_update_output$command_word$1$1({2}SI:U),F,0,0
S:Ldac_next_value$wave$1$1({1}SC:U),F,0,0
S:Ldac_next_value$counter$1$1({2}SI:U),F,0,0
S:Ldac_next_value$data_value$1$1({2}SI:U),F,0,0
S:Ldac_next_value$local_wave_ptr$1$1({3}DG,SI:U),F,0,0
S:Ldac_output_control_change$a_or_b$1$1({1}SC:U),F,0,0
S:G$sine_wave$0$0({256}DA256,SC:U),F,0,0
S:G$square_wave$0$0({256}DA256,SC:U),F,0,0
S:G$triangular_value_wave$0$0({256}DA256,SC:U),F,0,0
S:G$saw_wave$0$0({256}DA256,SC:U),F,0,0
S:G$wave_ptr_array$0$0({12}DA4,DG,SC:U),F,0,0
...
S:Fspi$__xinit_sine_wave$0$0({256}DA256,SC:U),C,0,0
S:Fspi$__xinit_square_wave$0$0({256}DA256,SC:U),C,0,0
S:Fspi$__xinit_triangular_value_wave$0$0({256}DA256,SC:U),C,0,0
S:Fspi$__xinit_saw_wave$0$0({256}DA256,SC:U),C,0,0
S:Fspi$__xinit_wave_ptr_array$0$0({12}DA4,DG,SC:U),C,0,0
