...
S:Lmain$data_byte$1$1({1}SC:U),F,0,0
S:Lmain$x$1$1({1}SC:U),F,0,0
S:Lmain$y$1$1({1}SC:U),F,0,0
S:Lmain$i$1$1({1}SC:U),F,0,0
S:Lmain$dac_on_off_flag$1$1({1}SC:U),F,0,0
S:Lmain$address$1$1({2}SI:U),F,0,0
S:Lmain$Welcome_txt$1$1({45}DA45,SC:U),F,0,0
S:Lmain$Welcome_lcd_txt$1$1({32}DA32,SC:U),F,0,0
S:Lmain$Instructions_txt$1$1({346}DA346,SC:U),F,0,0
S:Lmain$Enter_data_txt$1$1({14}DA14,SC:U),F,0,0
S:Lmain$Enter_Address_txt$1$1({17}DA17,SC:U),F,0,0
S:Lmain$Write_mode_txt$1$1({13}DA13,SC:U),F,0,0
S:Lmain$Write_complete_txt$1$1({18}DA18,SC:U),F,0,0
S:Lmain$Read_mode_txt$1$1({13}DA13,SC:U),F,0,0
S:Lmain$Data_read_txt$1$1({13}DA13,SC:U),F,0,0
S:Lmain$Read_complete_txt$1$1({17}DA17,SC:U),F,0,0
S:Lmain$LCD_address_jump_txt$1$1({19}DA19,SC:U),F,0,0
S:Lmain$LCD_coordinate_jump_txt$1$1({24}DA24,SC:U),F,0,0
S:Lmain$xcoordinate_txt$1$1({28}DA28,SC:U),F,0,0
S:Lmain$ycoordinate_txt$1$1({31}DA31,SC:U),F,0,0
S:Lmain$custom_character_txt$1$1({83}DA83,SC:U),F,0,0
S:Lmain$invalid_txt$1$1({16}DA16,SC:U),F,0,0
S:Lmain$invalid_address$1$1({18}DA18,SC:U),F,0,0
S:Lmain$DAC_on_txt$1$1({12}DA12,SC:U),F,0,0
S:Lmain$DAC_off_txt$1$1({13}DA13,SC:U),F,0,0
...
S:G$rtc_init$0$0({2}DF,SV:S),C,0,0
S:G$rtc_interrupt_handler$0$0({2}DF,SV:S),C,0,0
S:G$rtc_diplay$0$0({2}DF,SV:S),C,0,0
S:G$rtc_stop_time$0$0({2}DF,SV:S),C,0,0
S:G$rtc_start_time$0$0({2}DF,SV:S),C,0,0
S:G$rtc_reset_time$0$0({2}DF,SV:S),C,0,0
