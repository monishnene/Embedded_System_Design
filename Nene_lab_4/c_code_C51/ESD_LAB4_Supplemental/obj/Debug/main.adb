...
F:G$wave_interrupt_handler$0$0({2}DF,SV:S),C,0,0,1,1,0
F:G$waves_init$0$0({2}DF,SV:S),C,0,0,0,0,0
...
S:Lmain$Instructions_txt$1$1({135}DA135,SC:U),F,0,0
S:Lmain$DAC_on_txt$1$1({6}DA6,SC:U),F,0,0
S:Lmain$DAC_off_txt$1$1({7}DA7,SC:U),F,0,0
S:Lmain$Enter_data_txt$1$1({14}DA14,SC:U),F,0,0
S:Lmain$DAC_a_txt$1$1({24}DA24,SC:U),F,0,0
S:Lmain$DAC_b_txt$1$1({24}DA24,SC:U),F,0,0
S:Lmain$DAC_gain_inc_txt$1$1({17}DA17,SC:U),F,0,0
S:Lmain$DAC_gain_dec_txt$1$1({17}DA17,SC:U),F,0,0
S:Lmain$DAC_mode_txt$1$1({15}DA15,SC:U),F,0,0
S:Lmain$DAC_next_wave_txt$1$1({13}DA13,SC:U),F,0,0
...
S:G$dac_update_output$0$0({2}DF,SV:S),C,0,0
S:G$spi_clock_tick$0$0({2}DF,SV:S),C,0,0
S:G$spi_init$0$0({2}DF,SV:S),C,0,0
S:G$spi_write_word$0$0({2}DF,SV:S),C,0,0
S:G$dac_start_output$0$0({2}DF,SV:S),C,0,0
S:G$dac_stop_output$0$0({2}DF,SV:S),C,0,0
S:G$dac_next_wave$0$0({2}DF,SV:S),C,0,0
S:G$dac_output_control_change$0$0({2}DF,SV:S),C,0,0
...
S:G$wave_interrupt_handler$0$0({2}DF,SV:S),C,0,0
S:G$waves_init$0$0({2}DF,SV:S),C,0,0
