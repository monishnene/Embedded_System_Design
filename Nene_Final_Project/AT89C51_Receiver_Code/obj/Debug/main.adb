...
S:Lmain$value$1$1({1}SC:U),R,0,0,[r2]
S:Lmain$i$1$1({1}SC:U),R,0,0,[r3]
S:Lmain$command_word_a$1$1({2}SI:U),R,0,0,[r3,r4]
...
S:Lmain$Welcome_txt$1$1({38}DA38,SC:U),F,0,0
S:Lmain$Welcome_lcd_txt$1$1({33}DA33,SC:U),F,0,0
...
S:G$dac_set$0$0({2}DF,SV:S),C,0,0
S:G$spi_clock_tick$0$0({2}DF,SV:S),C,0,0
S:G$spi_init$0$0({2}DF,SV:S),C,0,0
S:G$spi_write_word$0$0({2}DF,SV:S),C,0,0
S:G$dac_set_a$0$0({2}DF,SV:S),C,0,0
S:G$dac_set_b$0$0({2}DF,SV:S),C,0,0
S:G$dac_increase_voltage$0$0({2}DF,SV:S),C,0,0
S:G$dac_decrease_voltage$0$0({2}DF,SV:S),C,0,0
