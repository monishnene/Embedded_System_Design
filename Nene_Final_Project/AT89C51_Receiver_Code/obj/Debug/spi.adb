...
F:G$dac_set_a$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$dac_set_b$0$0({2}DF,SV:S),Z,0,0,0,0,0
...
S:Ldac_set_a$data_word$1$1({2}SI:U),F,0,0
S:Ldac_set_a$command_word_a$1$1({2}SI:U),F,0,0
S:Ldac_set_b$data_word$1$1({2}SI:U),F,0,0
S:Ldac_set_b$command_word_b$1$1({2}SI:U),F,0,0
S:G$gain$0$0({2}SI:S),F,0,0
...
S:Fspi$__xinit_gain$0$0({2}SI:S),C,0,0
