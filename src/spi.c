...
255	,
    ...
    __xdata uint8_t* data_ptr;
    if(mode==0)
    {
        data_ptr=array_ptr[wave];
        command_word_a = *(data_ptr+counter)<<4;
        ...
        {
            command_word_a |= Gain_decrease_mask;
            command_word_b |= Gain_decrease_mask;
        }
